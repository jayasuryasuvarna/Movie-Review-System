...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, Sony Ericsson, Motorola web design" />
    ...
    <!--// Common Css -->
    <!-- Nav Css -->
    <link rel="stylesheet" href="<?php echo e(asset('admin/css/style4.css')); ?>">
    <!--// Nav Css -->
    <!-- Fontawesome Css -->
                    ...
                    <div class="col-md-3" style="margin-bottom: 2%;">
                        <div class="card ">
                            ...
                            <div class="card-body text-center">
                                                    <img src="<?php echo e(asset('admin/mphotos/'.$value->mimage)); ?>" width="230" height="300">

                                                  
                                <h3><?php echo e($value->mname); ?></h3>

                                <a href="/info/<?php echo e($value->mid); ?>">View More</a>
                            </div>
                        </div>
                    </div>
...
</html><?php /**PATH C:\wamp64\www\movie\resources\views/home.blade.php ENDPATH**/ ?>